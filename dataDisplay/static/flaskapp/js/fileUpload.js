...
$.fn.extend({
    "initUpload": function (opt) {
        ...
        uploadTools.initWithDownload(opt);//初始化选择文件按钮
...
var uploadTools = {
     ...
     * @param opt
     */
    "initWithDownload": function (opt) {
        var uploadId = opt.uploadId;
        $("#" + uploadId + " .uploadBts .modelDownload").on("click", function () {
    ...
    "initWithLayout": function (opt) {
        ...
        btsStr += "<div>";
        btsStr += "<div class='modelDownload'>模版下载</div>";
        btsStr += "</div>";
