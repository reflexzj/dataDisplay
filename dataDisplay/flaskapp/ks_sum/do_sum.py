# coding=utf-8
from dataDisplay.flaskapp.rules import methods
from dataDisplay.flaskapp.models import *
from dataDisplay.flaskapp.rules import  column_convert
...
def show_ks_sums(directory_name):
    ...
    all_conditions = read_ks_column('dataDisplay/flaskapp/ks_sum/ks_sum.xlsx')
